...
reduce() # Функция reduce() является мощным инструментом в Python, который позволяет сводить последовательности к одному значению, 
# применяя функцию к элементам последовательности. Она может быть полезна при выполнении различных операций, т
# аких как суммирование, умножение, поиск максимального или минимального значения и других. 
# Убедитесь, что вы импортируете функцию reduce из модуля functools, прежде чем использовать ее.
